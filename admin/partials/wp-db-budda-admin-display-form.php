...
<div class="wrap">
    ...
    <form method="post" name="new_booking" action="">
        <input type="hidden" id="<?php echo $this->plugin_name; ?>-action" name="<?php echo $this->plugin_name; ?>[action]" value="add_new_booking" />
        <?php wp_nonce_field($this->plugin_name.'-addnew'); ?>

        <div id="booking-dates"></div>
        <fieldset>
            <label for="<?php echo $this->plugin_name; ?>-dates">
                <input type="hidden" id="<?php echo $this->plugin_name; ?>-dates" name="<?php echo $this->plugin_name; ?>[dates]" value="" class="addnew-dates"/>
            </label>
        </fieldset>
        ...
        <fieldset>
             <legend ><span><?php _e('First name*', $this->plugin_name); ?></span></legend>
                 <label for="<?php echo $this->plugin_name; ?>-firstname">
                        <input type="text" id="<?php echo $this->plugin_name; ?>-firstname" name="<?php echo $this->plugin_name; ?>[firstname]" value="<?php echo $db_firstname; ?>"/>
                 </label>
        </fieldset>
        ...
        <fieldset>
            ...
            <label for="<?php echo $this->plugin_name; ?>-lastname">
                <input type="text" id="<?php echo $this->plugin_name; ?>-lastname" name="<?php echo $this->plugin_name; ?>[lastname]" value="<?php echo $db_lastname; ?>"/>
            </label>
        </fieldset>
        ...
        <fieldset>
           ...
           <label for="<?php echo $this->plugin_name; ?>-phone">
               <input type="text" id="<?php echo $this->plugin_name; ?>-phone" name="<?php echo $this->plugin_name; ?>[phone]"
                      placeholder="<?php _e('+__(___)___-__-__', $this->plugin_name);?>" value="<?php echo $db_phone; ?>"/>
           </label>
       </fieldset>
        ...
        <fieldset>
            ...
            <label for="<?php echo $this->plugin_name; ?>-details">
                <textarea id="<?php echo $this->plugin_name; ?>-details" name="<?php echo $this->plugin_name; ?>[details]"><?php echo $db_details; ?></textarea>
            </label>
        </fieldset>
