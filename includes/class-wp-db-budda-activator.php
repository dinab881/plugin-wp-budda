...
class Wp_Db_Budda_Activator {
  ...
  PRIMARY KEY (`booking_id`)
        ...
        $sql = "ALTER TABLE " . $table_name1 . " ADD FOREIGN KEY (booking_id) REFERENCES " . $table_name2 . "(booking_id)
    ON DELETE CASCADE;";
        $wpdb->query($sql);
        ...
        $startData = array(
            ...
            array(
                ...
                'comments' => 'We need individual menu, because we are vegans. What you can offer for us?',
            ...
            array(
                ...
                'comments' => 'Do you have children rooms?',
                'booking_date' => array('2016-02-07', '2016-03-07'),
                'approved' => '0'
            )
        );
